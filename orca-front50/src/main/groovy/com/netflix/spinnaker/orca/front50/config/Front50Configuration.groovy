...
class Front50Configuration {
  ...
  @Value('${front50.okhttp.readTimeoutMs:10000}')
  Integer okhttpReadTimeoutMs;

  @Value('${front50.okhttp.writeTimeoutMs:10000}')
  Integer okhttpWriteTimeoutMs;

  @Value('${front50.okhttp.connectTimeoutMs:10000}')
  Integer okhttpConnectTimeoutMs;
  ...
  Front50Service front50Service(Endpoint front50Endpoint, ObjectMapper mapper) {
    ...
    okHttpClient = okHttpClient.newBuilder()
        .readTimeout(okhttpReadTimeoutMs, TimeUnit.MILLISECONDS)
        .writeTimeout(okhttpWriteTimeoutMs, TimeUnit.MILLISECONDS)
        .connectTimeout(okhttpConnectTimeoutMs, TimeUnit.MILLISECONDS)
        .build();
